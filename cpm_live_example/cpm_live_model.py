import torch
from model_center.layer import Encoder, Decoder, Embedding, Linear, SegmentPositionEmbedding, LayerNorm
...
class CPMLive(torch.nn.Module):
    ...
    def forward(self, input : torch.Tensor, # (batch, seqlen)
        ...
        hidden_states = self.encoder(hidden_states, attention_mask, position_bias, zs=zs)
