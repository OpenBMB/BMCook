...
class Attention(bmt.DistributedModule):
    ...
    def forward(self, 
        ...
        #prune
        if att_z is not None:
            h_q = h_q * att_z.view(self.num_heads, 1, 1)
            h_k = h_k * att_z.view(self.num_heads, 1, 1)
            h_v = h_v * att_z.view(self.num_heads, 1, 1)
        ...
        # prune
        if att_z is not None:
            score = score * att_z.view(self.num_heads, 1)
